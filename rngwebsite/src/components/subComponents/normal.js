            ...
            <section id="Normal">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-5">
                        ...
                        <a href={"https://exalted-iridium-265519.appspot.com/normalDistribution?lower=0"+this.state.min+"&higher="+ this.state.max+"&amount="+this.state.amount}><Button>Try It</Button></a>
                        <div>
                        </div>
                        </Modal.Body>
                        <Modal.Footer>
